...
namespace BoardGamesManagerCoreTest.Extensions
{
    ...
    {
        private static readonly int[] _testCollection = new [] { 1, 2, 3, 4, 5, 6, 7 };
        ...
        public void IQueryable_is_correctly_paginated(int? pageSize, int? page, int[] expectedPaginatedResult)
        {
        ...
        [ClassData(typeof(PaginationTestData))]
        public void IEnumerable_is_correctly_paginated(int? pageSize, int? page, int[] expectedPaginatedResult)
        {
            TestIEnumerable(_enumerableCollection, pageSize, page, expectedPaginatedResult);
        }
        ...
        public void When_page_and_pageSize_are_null_then_all_elements_are_returned_from_IEnumerable(int? pageSize, int? page, int[] expectedPaginatedResult)
        {
            TestIEnumerable(_enumerableCollection, pageSize, page, expectedPaginatedResult);
        }
        ...
        public void When_page_is_null_then_first_elements_of_amount_equal_to_pageSize_are_returned_from_IEnumerable(int? pageSize, int? page, int[] expectedPaginatedResult)
        {
            TestIEnumerable(_enumerableCollection, pageSize, page, expectedPaginatedResult);
        }
        ...
        public void When_pageSize_is_null_then_all_elements_regardless_of_provided_page_number_are_returned_from_IEnumerable(int? pageSize, int? page, int[] expectedPaginatedResult)
        {
            TestIEnumerable(_enumerableCollection, pageSize, page, expectedPaginatedResult);
        }
        ...
        public void When_page_is_out_of_range_empty_then_empty_IEnumerable_is_returned(int? pageSize, int? page, int[] expectedPaginatedResult)
        {
            TestIEnumerable(_enumerableCollection, pageSize, page, expectedPaginatedResult);
        }
        ...
        public void When_IEnumerable_is_empty_then_empty_IEnumerable_is_returned_after_pagination_regardless_of_parameters_passed(int? pageSize, int? page)
        {
            TestIEnumerable(Enumerable.Empty<int>(), pageSize, page, new int[0]);
        }
        ...
        [ClassData(typeof(PaginationEmptyCollectionTestData))]
        public void When_IQueryable_is_empty_then_empty_IQueryable_is_returned_after_pagination_regardless_of_parameters_passed(int? pageSize, int? page)
        {
            TestIQueryable(Enumerable.Empty<int>().AsQueryable(), pageSize, page, new int[0]);
        }
